...
# (numpy int64/float64 can cause bigint overflow in psycopg2)

# ———————––

def *safe_row(row):
“”“Convert a tuple of values to native Python types safe for psycopg2.”””
out = []
for val in row:
if val is None:
out.append(None)
...
# Volume cleanup — null corrupt, then cast to safe Python int
...
if present_price:
    ...
    # Null out corrupt volume values
